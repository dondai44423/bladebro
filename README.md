...
Bladebro was run against [browser-use's Stealth Bench V1](https://github.com/browser-use/benchmark): 80 real, anti-bot-protected production sites across 11 vendors. It walked through **68 of 80 (85%)**, above every provider's best result on the published leaderboard (browser-use-cloud's best is 80%).
